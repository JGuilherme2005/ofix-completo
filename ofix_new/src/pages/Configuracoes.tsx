...
export default function Configuracoes() {
  ...
  const [editingMensagem, setEditingMensagem] = useState<any>(null);
  const [showDeleteDialog, setShowDeleteDialog] = useState(false);
  const [deletingProcedimento, setDeletingProcedimento] = useState<any>(null);
  const [showDeleteMensagemDialog, setShowDeleteMensagemDialog] =
    useState(false);
  const [deletingMensagem, setDeletingMensagem] = useState<any>(null);
