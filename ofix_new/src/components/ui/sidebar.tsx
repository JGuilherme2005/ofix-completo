...
const SidebarProvider = React.forwardRef<any, any>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
...
const Sidebar = React.forwardRef<any, any>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
...
const SidebarMenuButton = React.forwardRef<any, any>(({ asChild = false, isActive = false, variant = "default", size = "default", className, ...props }, ref) => {
  const Comp = asChild ? Slot : "button";
...
const SidebarMenuSubButton = React.forwardRef<any, any>(({ asChild = false, size = "md", isActive, className, ...props }, ref) => {
