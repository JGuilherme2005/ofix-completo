                      ...
                      <div className="space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                          ...
                          <motion.button
                            ...
                            className="flex-1 py-3 bg-slate-500 dark:bg-slate-800 hover:bg-slate-600 text-white rounded-lg transition-colors flex items-center justify-center space-x-2"
                            whileHover={{ scale: 1.02 }}
                            whileTap={{ scale: 0.98 }}
                          >
                            <X size={18} />
